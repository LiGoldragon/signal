...
- **rkyv feature-set** must match exactly across every rkyv-using crate per [lore/rust/rkyv.md](https://github.com/LiGoldragon/lore/blob/main/rust/rkyv.md): `default-features = false, features = ["std", "bytecheck", "little_endian", "pointer_width_32", "unaligned"]`. Pinned to rkyv 0.8.x.
